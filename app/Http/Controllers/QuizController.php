...
class QuizController extends Controller
{
    ...
    public function start_quiz(Quiz $quiz)
    {
        ...
        return view("pages.quiz_start", compact("quiz"));
    }

    public function check_quiz(Request $request, Quiz $quiz)
    {
        /* 
        ...
        */
        ...
        $timespent = 5; //? $request->input('time_spent', 0);
        if (Auth::check()) {
        ...
        return response()->json([
            "redirect" => route("quiz.result", $quizResult->id)
        ]);
    }
