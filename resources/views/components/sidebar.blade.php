<div class="bg-[#212121] text-white h-screen fixed left-0 top-0 flex flex-col transition-all duration-300 z-[60]"
    ...
    <div class="p-4 mt-3 flex justify-center">
        <button @click="$store.sidebar.open = !$store.sidebar.open"
            ...
            <i class="fa-solid fa-lg" :class="$store.sidebar.open ? 'fa-chevron-right' : 'fa-bars'"></i>
        </button>
    </div>
    ...
    <nav class="mt-4 flex-1 overflow-y-auto">
        <ul class="space-y-2 px-2">
            ...
            <li>
                <a href="{{ route('home') }}" class="flex items-center py-3 px-3 rounded transition-all whitespace-nowrap group
                   {{ request()->routeIs('home') ? 'bg-gray-700' : 'hover:bg-gray-700' }}">
                    ...
                    <span x-show="$store.sidebar.open" x-transition.opacity.duration.300
                        class="ml-3 font-medium">Home</span>
                </a>
            </li>
            ...
            <li>
                <a href="{{ route('quiz.create') }}" class="flex items-center py-3 px-3 rounded transition-all whitespace-nowrap group
                   {{ request()->routeIs('quiz.create') ? 'bg-gray-700' : 'hover:bg-gray-700' }}">
                    <div class="w-6 text-center"><i class="fa-regular fa-circle-question"></i></div>
                    <span x-show="$store.sidebar.open" x-transition.opacity.duration.300 class="ml-3 font-medium">Create
                        Quiz</span>
                </a>
            </li>

            <li>
                <a href="{{ route('exam.create') }}" class="flex items-center py-3 px-3 rounded transition-all whitespace-nowrap group
            ...
            <li>
                <a href="{{ route('study_guide.create') }}" class="flex items-center py-3 px-3 rounded transition-all whitespace-nowrap group
                   {{ request()->routeIs('study_guide.create') ? 'bg-gray-700' : 'hover:bg-gray-700' }}">
            ...
            <li>
                <a href="#"
                    ...
                    <span x-show="$store.sidebar.open" x-transition.opacity.duration.300
                        class="ml-3 font-medium">Search</span>
                </a>
            </li>
