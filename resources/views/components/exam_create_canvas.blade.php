        ...
        <div id="paper" 
            ...
            <template x-for="item in currentPageElements" :key="item.id">
                ...
                <div :id="item.id"
                    ...
                    {{-- 2. ÖĞRENCİ BİLGİ TABLOSU (HİZALAMA DÜZELTİLDİ) --}}
                    ...
                    {{-- 3. ÇOKTAN SEÇMELİ (A-B-C-D SİSTEMİ EKLENDİ) --}}
                    ...
                    {{-- 7. CUSTOM SORU (Basit Metin Kutusu gibi davranır) --}}
