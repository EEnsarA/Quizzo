    ...
    <div class="flex-1 overflow-y-auto p-4 space-y-6 custom-scrollbar">
        ...
        <div>
            ...
            <div class="grid grid-cols-3 gap-2">
                <div draggable="true" @dragstart="dragStart($event, 'heading')"
                    class="bg-[#333333] hover:bg-[#3e3e42] p-2 rounded flex flex-col items-center cursor-grab gap-1 transition">
                    <i class="fa-solid fa-heading text-white"></i>
                    <span class="text-[10px] text-gray-400">Başlık</span>
                </div>
                <div draggable="true" @dragstart="dragStart($event, 'sub_heading')"
                    class="bg-[#333333] hover:bg-[#3e3e42] p-2 rounded flex flex-col items-center cursor-grab gap-1 transition">
                ...
                <div draggable="true" @dragstart="dragStart($event, 'box')"
                    class="bg-[#333333] hover:bg-[#3e3e42] p-2 rounded flex flex-col items-center cursor-grab gap-1 transition">
        ...
        <div>
            ...
            <div class="space-y-2">
                <div draggable="true" @dragstart="dragStart($event, 'header_block')"
                    class="flex items-center gap-2 bg-[#333333] hover:bg-[#3e3e42] p-2 rounded cursor-grab">
                    <i class="fa-solid fa-hotel text-blue-400"></i> <span class="text-xs text-gray-300">Okul
                        Başlığı</span>
                </div>
                <div draggable="true" @dragstart="dragStart($event, 'student_info')"
                    class="flex items-center gap-2 bg-[#333333] hover:bg-[#3e3e42] p-2 rounded cursor-grab">
                    <i class="fa-solid fa-user-graduate text-blue-400"></i> <span class="text-xs text-gray-300">Öğrenci
                        Bilgi</span>
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="space-y-2">
                <div draggable="true" @dragstart="dragStart($event, 'multiple_choice')"
                    class="group bg-[#333333] hover:bg-[#3e3e42] p-2 rounded border border-[#3e3e42] hover:border-green-500 cursor-grab flex items-center gap-3">
                    <i class="fa-solid fa-list-ul text-green-500"></i>
                    <span class="text-xs text-gray-300">Çoktan Seçmeli</span>
                </div>
                <div draggable="true" @dragstart="dragStart($event, 'open_ended')"
                    class="group bg-[#333333] hover:bg-[#3e3e42] p-2 rounded border border-[#3e3e42] hover:border-orange-500 cursor-grab flex items-center gap-3">
                    <i class="fa-solid fa-align-left text-orange-500"></i>
                    <span class="text-xs text-gray-300">Klasik</span>
                </div>
                <div draggable="true" @dragstart="dragStart($event, 'fill_in_blanks')"
                    class="group bg-[#333333] hover:bg-[#3e3e42] p-2 rounded border border-[#3e3e42] hover:border-purple-500 cursor-grab flex items-center gap-3">
                    <i class="fa-solid fa-ellipsis text-purple-500"></i>
                    <span class="text-xs text-gray-300">Boşluk Doldurma</span>
                </div>
                <div draggable="true" @dragstart="dragStart($event, 'true_false')"
                    class="group bg-[#333333] hover:bg-[#3e3e42] p-2 rounded border border-[#3e3e42] hover:border-red-500 cursor-grab flex items-center gap-3">
                    <i class="fa-solid fa-check-double text-red-500"></i>
                    <span class="text-xs text-gray-300">Doğru / Yanlış</span>
                </div>
                <div draggable="true" @dragstart="dragStart($event, 'custom_question')"
                    class="group bg-[#333333] hover:bg-[#3e3e42] p-2 rounded border border-[#3e3e42] hover:border-yellow-500 cursor-grab flex items-center gap-3">
