...
@section("content")
    ...
    <div class="flex flex-col h-[calc(100vh-theme(spacing.16))] bg-[#1e1e1e] text-[#cccccc] font-sans overflow-hidden"
        ...
        <form id="quiz-create-form" action="{{ route("quiz.add") }}" method="POST" enctype="multipart/form-data"
            ...
            <header
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex flex-col justify-center">
                        ...
                        <span class="text-[10px] font-bold text-green-500 uppercase tracking-widest mb-0.5">Quiz
                            Oluşturucu</span>
                        ...
                        <input type="text" name="title" id="title"
                            ...
                            placeholder="Quiz Adı Giriniz" value="{{ old('title', 'Yeni Quiz') }}" required>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <button type="button" @click="submitQuiz('{{ route('quiz.add') }}')"
                                ...
                                <div class="group">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" name="subject"
                                            ...
                                            placeholder="Örn: Tarih, Matematik" value="{{ old('subject') }}">
                                    </div>
